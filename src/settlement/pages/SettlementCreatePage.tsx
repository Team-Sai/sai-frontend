...
export default function SettlementCreatePage(){
  ...
  async function addParticipant(){
    ...
    }catch(e){setError('participantLookup',e instanceof Error?e.message:'회원 조회 중 오류가 발생했습니다.')}finally{setLooking(false)}
  }
