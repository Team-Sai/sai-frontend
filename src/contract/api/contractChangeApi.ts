...
function isCurrentContractConditions(value: unknown): value is CurrentContractConditions {
...
export async function requestContractChange(
    ...
    const response = await authFetch(`/api/contracts/${contractId}/change-requests`, {
        method: 'POST',
